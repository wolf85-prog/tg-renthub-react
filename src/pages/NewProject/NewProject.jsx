        ...
        names: [
            {
                ...
                subnames: [
                    ...
                    {id: 16, name: 'ProTone',},
                    {id: 17, name: 'dB Technologies',},
                    {id: 18, name: 'Peavey',},
                    {id: 19, name: 'Yorkville',},
                    {id: 20, name: 'Dynacord',},
                    {id: 21, name: 'Mackie',},
                    {id: 22, name: 'QSC',},
                    {id: 23, name: 'Nova',},
            ...
            },
            {
                ...
                name: 'Amplifires',
                subnames: [
                    {id: 1, name: 'Crest Audio',},
                    {id: 2, name: 'Lab Gruppen',},
                    {id: 3, name: 'Crown',},
                    {id: 4, name: 'd&b Audiotechnik',},
                    {id: 5, name: 'L-Acoustics',},
                    {id: 6, name: 'Nexo',},
                    {id: 7, name: 'Turbosound',},
                    {id: 8, name: 'Clair Brothers',},
                    {id: 9, name: 'Coda Audio',},
                    {id: 10, name: 'Electro Voice',},
                    {id: 11, name: 'EAW',},
                    {id: 12, name: 'Bose',},
                    {id: 13, name: 'RCF',},
                    {id: 14, name: 'JBL',},
                    {id: 15, name: 'HK Audio',},
                    {id: 16, name: 'Martin Audio',},
                    {id: 17, name: 'Funktion One',},
                    {id: 18, name: 'ProTone',},
                    {id: 19, name: 'dB Technologies',},
                    {id: 20, name: 'Peavey',},
                    {id: 21, name: 'Yorkville',},
                    {id: 22, name: 'Dynacord',},
                    {id: 23, name: 'Mackie',},
                    {id: 24, name: 'QSC',},
                    {id: 25, name: 'Nova',},
            ...
            },
            {
                ...
                subnames: [
                    {id: 1, name: 'Digico',},
                    {id: 2, name: 'Yamaha',},
                    {id: 3, name: 'Allen & Heath',},
                    {id: 4, name: 'Midas',},
                    {id: 5, name: 'Digidesign',},
                    {id: 6, name: 'AVID',},
                    {id: 7, name: 'SSL',},
                    {id: 8, name: 'Behringer',},
                    {id: 9, name: 'Soundcraft',},
                    {id: 10, name: 'Mackie',},
                    {id: 11, name: 'QSC',},
                    {id: 12, name: 'CRCBOX',},
                    {id: 13, name: 'Other',},
